...
class LoginController extends GetxController {
  ...
  Future<LoginModel?> sessionCall() async {
    if (await loginCall()==true) {
      final responsed = await http.post(Uri.parse(
          'https://api.themoviedb.org/3/authentication/session/new?api_key=c6bd8982f6e8aaa3c24cef0599a47755'),
      ...
      if (responsed.statusCode == 200){
        ...
        Get.snackbar('Login Failed!',
            'Sever responded: ${responsed.statusCode}:${responsed.reasonPhrase
                .toString()}');
        refresh();
      }
    }else{Get.snackbar('Login Failed',
  ...
  Future<bool> loginCall() async {
    ...
    final responsed = await http.post(Uri.parse(
        'https://api.themoviedb.org/3/authentication/token/validate_with_login?api_key=c6bd8982f6e8aaa3c24cef0599a47755'),
    headers: <String, String>{'Content-Type': 'application/json; charset=UTF-8'},
      body: jsonEncode(<String, String>{
